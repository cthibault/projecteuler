...
{
    public static class EulerSolutions
    {
        #region Enumerations
        ...
        public static long problem3_1()
        {
            return Convert.ToInt64(600851475143d.getPrimeFactors().Max());
        }

        public static int problem4_1()
        {
            int max = 0;
            int term = 0;
        ...
        public static long problem5_1()       //TODO: I need a better solution for this problem!
        {
            long answer = -1;
        ...
        public static double problem8_1()
        {
        ...
        public static long problem10_1()
        {
            long sum = 2;
        ...
        public static double problem10_2()        //TODO: Find a better way to implement Eratosthenes Sieve
        {
            long maxTerm = 2000000;
        ...
        public static double problem11_1()
        {
        ...
        private static void printGrid(double[,] table)
        {
            for (int x = 0; x < 20; x++)
            {
                for (int y = 0; y < 20; y++)
        ...
        private static double productNorth(double[,] table, int x, int y, int consecutiveTerms)
        {
        ...
        private static double productNorthEast(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        private static double productEast(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        private static double productSouthEast(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        private static double productSouth(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        private static double productSouthWest(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        private static double productWest(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        private static double productNorthWest(double[,] table, int x, int y, int consecutiveTerms)
        {
            //Console.Write(table[x, y]);
            if (consecutiveTerms == 1)
                return table[x, y];
        ...
        public static double problem12_1()
        {
            double term = 0;
        ...
        public static long problem13_1()
        {
            long sum = 0;
            int digitLenth = 50;
        ...
        public static string problem14_1()
        {
        ...
        private static double recursiveSequence(Dictionary<double, double> dict, double startNum)
        {
            double nextTerm = 1;
            double steps = 0;
        ...
        public static double problem15_1()
        {
            int level = 20;
            double routes = 0;
        ...
        public static IntX problem16_1()
        {
            return IntX.Pow(2, 1000).SumOfDigits();
        }

        public static int problem17_1()
        {
        ...
        public static IntX problem20_1()
        {
            IntX number = 100;
